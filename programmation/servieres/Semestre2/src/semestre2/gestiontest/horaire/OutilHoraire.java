...
public class OutilHoraire {
    ...
    /**
     * Nombre maximum de minutes dans un horaire de la journée,
     * ou conversion en minutes de 23h59
     */
    private static final int MAX_MIN_JOUR = 1439;
     ...
     * @return vrai si le caractère argument contient un chiffre
     */
     ...
     * @return un booléen égal à vrai si l'horaire testé est valide
     */
    public static boolean estHoraireValide(String aTester) {
        ...
        if (aTester.length() == 5 && aTester.charAt(2) == 'h') {
            ...
            if (estChiffre(aTester.charAt(4))) {
    ...
    public static String convertir(int horaire) {
        ...
        if (horaire >= 0 && horaire <= MAX_MIN_JOUR) {
            
            // horaire valide : on le convertit
            heure = horaire / 60;
            minute = horaire % 60;
            conversion.append(heure < 10 ? "0" : "")
                      .append(heure)
                      .append("h")
                      .append(minute < 10 ? "0" : "")
                      .append(minute);
    ...
    public static int convertir(String horaire) {
        ...
        if (estHoraireValide(horaire)) {
            ...
            heure = (horaire.charAt(0) - '0') * 10 + (horaire.charAt(1) - '0');
