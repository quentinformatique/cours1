...
public class TarifSpectacle {
    ...
    private static final int BILLET_DANSE = 29;
    
    /** prix de base d'une place pour un concert */
    private static final int BILLET_CONCERT = 27;
     ...
     * @param adherent    un booléen égal à vrai si le spectateur possède une carte
     *                    d'adhérent
